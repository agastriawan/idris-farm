                ...
                <div class="col-md-7 col-sm-7">
                    @if ($first)
                        <a href="{{ asset('image_gallery/' . $first->image) }}"
                            ...
                            <img src="{{ asset('image_gallery/' . $first->image) }}" alt="img"
                                class="round20">
                        </a>
                    @endif
                </div>
                ...
                <div class="col-md-5 col-sm-5">
                    @if ($second)
                        <a href="{{ asset('image_gallery/' . $second->image) }}"
                            class="gallery-com-thumb first-item img-popup w-100 round20">
                            <img src="{{ asset('image_gallery/' . $second->image) }}" alt="img"
                                class="round20">
                        </a>
                    @endif
                </div>
                ...
                <div class="d-flex flex-sm-nowrap flex-wrap justify-content-between gap-lg-4 gap-3">
                    @if ($third)
                        <a href="{{ asset('image_gallery/' . $third->image) }}"
                            ...
                            <img src="{{ asset('image_gallery/' . $third->image) }}" alt="img"
                                class="round20">
                        </a>
                    @endif
                    ...
                    @if ($fourth)
                        <a href="{{ asset('image_gallery/' . $fourth->image) }}"
                            class="gallery-com-thumb secound img-popup w-100 round20">
                            <img src="{{ asset('image_gallery/' . $fourth->image) }}" alt="img"
                                class="round20">
                        </a>
                    @endif
                    ...
                    <div class="d-grid gap-lg-4 gap-3">
                        @if ($fifth)
                            <a href="{{ asset('image_gallery/' . $fifth->image) }}"
                                ...
                                <img src="{{ asset('image_gallery/' . $fifth->image) }}" alt="img"
                                    class="round20">
                            </a>
                        @endif

                        <a href="{{ url('/gallery') }}" class="cmn-btn d-center">
